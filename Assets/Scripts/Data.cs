...
public class Data : MonoBehaviour
{
    ...
    public int factorHealth = 3;                                                    //固化后生命值扩大倍数
    ...
    public int factorDamage = 3;                                                  //固化后单次弹道伤害扩大倍数
    ...
    public int factorProduction = 3;                                             //固化后生产量扩大倍数
    public float productionCoolDownTime = 1.0f;                      //生产间隔时间
    /*------------------------------------------------EOF---------------------------------------------------------------*/
